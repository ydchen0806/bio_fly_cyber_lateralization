...
\textbf{d},~Synapse-weighted neurotransmitter mass in KC upstream input by hemisphere. Supplementary videos in \texttt{paper/video/food\_memory\_cs\_plus\_left.mp4} and \texttt{paper/video/food\_memory\_cs\_plus\_right.mp4} show mirrored food-odour search simulations; \texttt{paper/video/oct\_mch\_mirror\_assay\_scene\_key\_conditions.mp4} and \texttt{paper/video/oct\_mch\_mirror\_assay\_scene\_mb\_perturbations.mp4} show the OCT/MCH mirror-side assay with trajectory tails and formal-statistics insets.}
