...
本文档对应 `/unify/ydchen/unidit/bio_fly/ppt/cyber_fly_teacher_report.tex`，按页给出汇报口径。整体讲法是：先讲问题，再讲结构证据，再讲连接组传播，再讲行为框架，最后主动说明边界和后续验证。
...
## 第20页 实验 2 的机制图：为什么要加 DN/motor primitive
...
## 第25页 会议反馈后的新增实验：5-HT 与 Glu 分拆验证
...
## 第27页 DPM 光遗传验证：先证明 release pattern
...
## 第27页 会议反馈后的新增实验：群体 T-maze 可观测指标
